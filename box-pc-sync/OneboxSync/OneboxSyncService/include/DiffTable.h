...
public:
	...
	virtual int32_t getTopOper(OperNode& operNode, bool isTaskIdle) = 0;
	...
	virtual int32_t getDiffCount() = 0;

	virtual int32_t getNormalDiffCount() = 0;

	virtual int32_t getErrorDiffCount() = 0;
