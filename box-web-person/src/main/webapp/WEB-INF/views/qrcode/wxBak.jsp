...
<head>
    ...
    <script src="${ctx}/static/js/Components.js" type="text/javascript"></script>
    <script src="${ctx}/static/js/tabs.js" type="text/javascript"></script>
    <style type="text/css">
        .successQR {
            width: 100px;
            height: 100px;
    ...
    <div style="background: url(${ctx}/static/assets/images/bg1_02.png);background-size:cover ;position: absolute;left: 0;top:60px;right: 0px;height: 340px">
        <div style="width: 1280px;margin: 0 auto">
            <div class="box messagebox-success" style="position: relative;">
                ...
                <div id="qrcode">
                    <p style="text-align: center;font-size: 16px; color: #999999;">再用微信扫码，启动备份机器人</p>
