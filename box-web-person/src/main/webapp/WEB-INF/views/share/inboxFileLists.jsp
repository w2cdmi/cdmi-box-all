...
<head>
    ...
    <script src="${ctx}/static/components/Toolbar.js"></script>
    <script src="${ctx}/static/components/Breadcrumb.js"></script>
    <script src="${ctx}/static/components/Datagrid.js"></script>
...
<div class="container" style="background: #fff;">
    ...
    <div class="popover bottom" id="table_popover" style="width: 120px;">
    ...
    <div id="deleteDialog">
        <p style="padding:10px;text-align: center;height:30px;line-height:30px;font-size:18px;in"><i class="fa fa-info-circle"></i>确认要删除吗？</p>
        <div class="form-control" style="text-align: right">
            <button type="button" id="cancel_button">取消</button>
            <button type="button" id="ok_button">确定</button>
        </div>
