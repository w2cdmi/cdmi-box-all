...
<head>
    ...
    <script src="${ctx}/static/components/SelectFolderDialog.js?v=${version}"></script>
    <script src="${ctx}/static/components/SelectFolderDialogCopyTeam.js?v=${version}"></script>
...
<div class="container" style="background: #fff;">
    ...
    <%@ include file="../common/selectFolderDialogCopyTeam.jsp" %>
    <%@ include file="../common/shareDialog.jsp" %>
    <div class="popover bottom" id="table_popover" style="width: 170px;">
        <div class="arrow" style="left: 146px;"></div>
        <dl class="menu">
            <dt role="0,1,-5,-7" id="link">
                <i class="fa fa-link"></i>外发
            </dt>
            <dt role="1" id="downFile">
                <i class="fa fa-download"></i>下载
            </dt>
            <dt role="0,1,-5,-7" id="rename">
                <i class="fa fa-pencil-square-o"></i>重命名
            </dt>
            <dt role="0,1,-5,-7" id="moveTo">
                <i class="fa fa-files-o"></i>移动到...
            </dt>
            <dt role="0,1,-5,-7" id="copyToTeam">
                <i class="fa fa-files-o"></i>另存为...
            </dt>
            <dt role="0,1,-5,-7" id="delete">
                <i class="fa fa-minus"></i>删除
            </dt>
            <dt role="0,-5,-7" id="folderInfo">
                <i class="fa fa-info"></i>文件夹信息
            </dt>
            <dt role="1" id="fileInfo">
                <i class="fa fa-info"></i>文件信息
            </dt>
            <dt role="1" id="fileVersionInfo">
                <i class="fa fa-history"></i>查看版本
            </dt>
        </dl>
    </div>
    ...
    <div id="infoDialog">
        <div id="fileInfo">
            <div class="file-info">
                <i id="fileIco"></i>
                <span class="file-name txt-ellipsis" id="fileName" style="display: inline-block;"></span>
