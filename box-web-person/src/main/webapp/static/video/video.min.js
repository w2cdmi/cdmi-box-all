!function (t, e) {
    ...
    function f() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "div", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = arguments[3], i = ce.createElement(t);
    ...
    function A(t) {
        ...
        var n = ce.documentElement, r = ce.body, i = n.clientLeft || r.clientLeft || 0, o = ie.pageXOffset || r.scrollLeft, s = e.left + o - i, a = n.clientTop || r.clientTop || 0, l = ie.pageYOffset || r.scrollTop, c = e.top + l - a;
    ...
    function X(t, e, n) {
        ...
        if ("string" == typeof e && (e = {type: e, target: t}), e = W(e), r.dispatcher && r.dispatcher.call(t, e, n), i && !e.isPropagationStopped() && !0 === e.bubbles) X.call(null, i, e, n); else if (!i && !e.defaultPrevented) {
            var o = R(e.target);
    ...
    function vt(t) {
        ...
        function i() {
            if (!c) {
                ...
                var r = g, i = null;
                return 0 !== e ? (r = {body: n(), statusCode: e, method: p, headers: {}, url: h, rawRequest: a}, a.getAllResponseHeaders && (r.headers = ar(a.getAllResponseHeaders()))) : i = new Error("Internal XMLHttpRequest Error"), s(i, r, r.body)
            }
        }
        ...
        var l, c, u, h = a.url = t.uri || t.url, p = a.method = t.method || "GET", d = t.body || t.data, f = a.headers = t.headers || {}, v = !!t.sync, y = !1, g = {body: void 0, headers: {}, statusCode: 0, method: p, url: h, rawRequest: a};
    ...
    function jt(t, e, n) {
        ...
        var s = {color: i, backgroundColor: o, position: "relative", left: 0, right: 0, top: 0, bottom: 0, display: "inline"};
        ...
        "" === e.vertical ? this.applyStyles({left: this.formatStyle(a, "%"), width: this.formatStyle(e.size, "%")}) : this.applyStyles({top: this.formatStyle(a, "%"), height: this.formatStyle(e.size, "%")}), this.move = function (t) {
            this.applyStyles({top: this.formatStyle(t.top, "px"), bottom: this.formatStyle(t.bottom, "px"), left: this.formatStyle(t.left, "px"), right: this.formatStyle(t.right, "px"), height: this.formatStyle(t.height, "px"), width: this.formatStyle(t.width, "px")})
        }
    }
    ...
    function Dt(t, e, n) {
        ...
        var s = "", a = !1, l = t, c = e, u = n, h = null, p = "", d = !0, f = "auto", v = "start", y = 50, g = "middle", m = 50, _ = "middle";
    ...
    function qt() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], n = arguments[2], i = arguments[3], o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [], s = arguments.length > 5 && void 0 !== arguments[5] && arguments[5], a = e[0], l = e.slice(1);
    ...
    function Gt(t) {
        ...
        t = t < 0 ? 0 : t;
        var n = Math.floor(t % 60), r = Math.floor(t / 60 % 60), i = Math.floor(t / 3600), o = Math.floor(e / 60 % 60), s = Math.floor(e / 3600);
    ...
    var te, ee = "6.2.8", ne = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    te = "undefined" != typeof window ? window : void 0 !== ne ? ne : "undefined" != typeof self ? self : {};
    var re, ie = te, oe = {}, se = (Object.freeze || Object)({default: oe}), ae = se && oe || se, le = void 0 !== ne ? ne : "undefined" != typeof window ? window : {};
    "undefined" != typeof document ? re = document : (re = le["__GLOBAL_DOCUMENT_CACHE@4"]) || (re = le["__GLOBAL_DOCUMENT_CACHE@4"] = ae);
    var ce = re, ue = ie.navigator && ie.navigator.userAgent || "", he = /AppleWebKit\/([\d.]+)/i.exec(ue), pe = he ? parseFloat(he.pop()) : null, de = /iPad/i.test(ue), fe = /iPhone/i.test(ue) && !de, ve = /iPod/i.test(ue), ye = fe || de || ve, ge = function () {
        ...
        }(), be = me && /webkit/i.test(ue) && _e < 2.3, Te = me && _e < 5 && pe < 537, Ce = /Firefox/i.test(ue), ke = /Edge/i.test(ue), we = !ke && /Chrome/i.test(ue), Ee = function () {
        ...
        }(), je = /Safari/i.test(ue) && !we && !me && !ke, Ae = je || ye, Pe = h() && ("ontouchstart" in ie || ie.DocumentTouch && ie.document instanceof ie.DocumentTouch), Ne = h() && "backgroundSize" in ie.document.createElement("video").style,
        Oe = (Object.freeze || Object)({IS_IPAD: de, IS_IPHONE: fe, IS_IPOD: ve, IS_IOS: ye, IOS_VERSION: ge, IS_ANDROID: me, ANDROID_VERSION: _e, IS_OLD_ANDROID: be, IS_NATIVE_ANDROID: Te, IS_FIREFOX: Ce, IS_EDGE: ke, IS_CHROME: we, CHROME_VERSION: Ee, IS_IE8: Se, IE_VERSION: xe, IS_SAFARI: je, IS_ANY_SAFARI: Ae, TOUCH_ENABLED: Pe, BACKGROUND_SIZE_SUPPORTED: Ne}), Me = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            return typeof t
        } : function (t) {
            ...
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !!xe && xe < 11, r = Ve.levels[He], o = new RegExp("^(" + r + ")$");
    ...
    Ve = function () {
        ...
        Ue("log", e)
    }, Ve.levels = {all: "log|warn|error", error: "error", off: "", warn: "warn|error", DEFAULT: He}, Ve.level = function (t) {
        if ("string" == typeof t) {
    ...
    var tn = ["touchstart", "touchmove"], en = (Object.freeze || Object)({fixEvent: W, on: U, off: z, trigger: X, one: q}), nn = !1, rn = void 0, on = function () {
        if (h()) {
    ...
    var hn = function (t) {
        ...
        return n ? (r = t.eventBusEl_, e.length >= 3 && e.shift(), i = e[0], o = e[1]) : (r = e[0], i = e[1], o = e[2]), dn(r), fn(i), vn(o), o = ln(t, o), {isTargetingSelf: n, target: r, type: i, listener: o}
    }, gn = function (t, e, n, r) {
        ...
        return t.prototype.dispose = function () {
            ...
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : t, r = this.player_.language && this.player_.language(), i = this.player_.languages && this.player_.languages(), o = i && i[r], s = r && r.split("-")[0], a = i && i[s], l = n;
            ...
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.children_.length, i = void 0, o = void 0;
            if ("string" == typeof e) {
                o = $(e);
            ...
            if (n) {
                ...
                o = Array.isArray(n) ? n : Object.keys(n), o.concat(Object.keys(this.options_).filter(function (t) {
                    ...
                    return "string" == typeof t ? (r = t, i = n[r] || e.options_[r] || {}) : (r = t.name, i = t), {name: r, opts: i}
                }).filter(function (e) {
            ...
            this.on("touchstart", function (r) {
                1 === r.touches.length && (e = {pageX: r.touches[0].pageX, pageY: r.touches[0].pageY}, t = (new Date).getTime(), n = !0)
            }), this.on("touchmove", function (t) {
                if (t.touches.length > 1) n = !1; else if (e) {
                    var r = t.touches[0].pageX - e.pageX, i = t.touches[0].pageY - e.pageY, o = Math.sqrt(r * r + i * i);
                    o > 10 && (n = !1)
                }
            });
            var r = function () {
    ...
    var jn = ot, An = function (t) {
        ...
        function e(n, r) {
            ...
            return i.opened_ = i.hasBeenOpened_ = i.hasBeenFilled_ = !1, i.closeable(!i.options_.uncloseable), i.content(i.options_.content), i.contentEl_ = f("div", {className: Mn + "-content"}, {role: "document"}), i.descEl_ = f("p", {className: Mn + "-description vjs-control-text", id: i.el().getAttribute("aria-describedby")}), v(i.descEl_, i.description()), i.el_.appendChild(i.descEl_), i.el_.appendChild(i.contentEl_), i
        }
    ...
    var Dn = function (t) {
        function e() {
            var n, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            Ie(this, e);
    ...
    var Rn = function (t, e) {
        ...
        }(), zn = {alternative: "alternative", captions: "captions", main: "main", sign: "sign", subtitles: "subtitles", commentary: "commentary"}, Xn = {alternative: "alternative", descriptions: "descriptions", main: "main", "main-desc": "main-desc", translation: "translation", commentary: "commentary"}, qn = {subtitles: "subtitles", captions: "captions", descriptions: "descriptions", chapters: "chapters", metadata: "metadata"}, Kn = {disabled: "disabled", hidden: "hidden", showing: "showing"},
        Yn = function (t) {
            function e() {
                ...
                var a = {id: r.id || "vjs_track_" + L(), kind: r.kind || "", label: r.label || "", language: r.language || ""};
        ...
        }, Zn = (Object.freeze || Object)({parseUrl: Gn, getAbsoluteURL: $n, getFileExtension: Jn, isCrossOrigin: Qn}), tr = st, er = Object.prototype.toString, nr = t(function (t, e) {
            function n(t) {
    ...
    var hr = function (t, e) {
        ...
        function e() {
            ...
            var o = Q(i, {kind: qn[i.kind] || "subtitles", language: i.language || i.srclang || ""}), s = Kn[o.mode] || "disabled", a = o.default;
    ...
    var _r = {audio: {ListClass: Bn, TrackClass: fr, capitalName: "Audio"}, video: {ListClass: Vn, TrackClass: vr, capitalName: "Video"}, text: {ListClass: Hn, TrackClass: dr, capitalName: "Text"}};
    Object.keys(_r).forEach(function (t) {
        _r[t].getterName = t + "Tracks", _r[t].privateName = t + "Tracks_"
    });
    var br = {remoteText: {ListClass: Hn, TrackClass: dr, capitalName: "RemoteText", getterName: "remoteTextTracks", privateName: "remoteTextTracks_"}, remoteTextEl: {ListClass: Wn, TrackClass: mr, capitalName: "RemoteTextTrackEls", getterName: "remoteTextTrackEls", privateName: "remoteTextTrackEls_"}}, Tr = Q(_r, br);
    ...
    mt.prototype = Cr(Error.prototype), mt.prototype.constructor = mt, mt.Errors = {BadSignature: {code: 0, message: "Malformed WebVTT signature."}, BadTimeStamp: {code: 1, message: "Malformed time stamp."}}, bt.prototype = {
        set: function (t, e) {
    ...
    var kr = {"&amp;": "&", "&lt;": "<", "&gt;": ">", "&lrm;": "‎", "&rlm;": "‏", "&nbsp;": " "}, wr = {c: "span", i: "i", b: "b", u: "u", ruby: "ruby", rt: "rt", v: "span", lang: "span"}, Er = {v: "title", lang: "lang"}, Sr = {rt: "ruby"},
    ...
    xt.prototype.applyStyles = function (t, e) {
        ...
        var e = t.div ? t.div.offsetHeight : t.tagName ? t.offsetHeight : 0, n = t.div ? t.div.offsetWidth : t.tagName ? t.offsetWidth : 0, r = t.div ? t.div.offsetTop : t.tagName ? t.offsetTop : 0;
        return t = t.div ? t.div.getBoundingClientRect() : t.tagName ? t.getBoundingClientRect() : t, {left: t.left, right: t.right, top: t.top || r, height: t.height || e, bottom: t.bottom || r + (t.height || e), width: t.width || n}
    ...
    Nt.processCues = function (t, e, n) {
        ...
        if (r.style.position = "absolute", r.style.left = "0", r.style.right = "0", r.style.top = "0", r.style.bottom = "0", r.style.margin = "1.5%", n.appendChild(r), function (t) {
            ...
            var i = [], o = At.getSimpleBoxPosition(r), s = Math.round(.05 * o.height * 100) / 100, a = {font: s + "px sans-serif"};
            !function () {
        ...
        reportOrThrowError: function (t) {
            ...
            function n(t) {
                ...
                if (Tt(t, function (t, n) {
                    ...
                    n.width = e.get("width", 100), n.lines = e.get("lines", 3), n.regionAnchorX = e.get("regionanchorX", 0), n.regionAnchorY = e.get("regionanchorY", 100), n.viewportAnchorX = e.get("viewportanchorX", 0), n.viewportAnchorY = e.get("viewportanchorY", 100), n.scroll = e.get("scroll", ""), i.onregion && i.onregion(n), i.regionList.push({id: e.get("id"), region: n})
                }
            }
            ...
            function r(t) {
                ...
                }, /[^\d]:/, /,/), i.ontimestampmap && i.ontimestampmap({MPEGTS: e.get("MPEGTS"), LOCAL: e.get("LOCAL")})
            }
    ...
    var Or = Dt, Mr = {"": !0, up: !0}, Ir = Bt, Dr = t(function (t) {
        ...
        return De(e, t), e.prototype.manualProgressOn = function () {
            ...
            var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = arguments[1], r = this.createRemoteTextTrack(e);
    ...
    var Rr = {}, Br = {buffered: 1, currentTime: 1, duration: 1, seekable: 1, played: 1}, Fr = {setCurrentTime: 1}, Vr = function t(e) {
        if (Array.isArray(e)) {
            var n = [];
    ...
    var Wr = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            n = r({innerHTML: '<span aria-hidden="true" class="vjs-icon-placeholder"></span>', className: this.buildCSSClass(), tabIndex: 0}, n), "button" === e && ze.error("Creating a ClickableComponent with an HTML element of " + e + " is not supported; use a Button instead."), i = r({role: "button", "aria-live": "polite"}, i), this.tabIndex_ = n.tabIndex;
    ...
    var zr = {monospace: "monospace", sansSerif: "sans-serif", serif: "serif", monospaceSansSerif: '"Andale Mono", "Lucida Console", monospace', monospaceSerif: '"Courier New", monospace', proportionalSansSerif: "sans-serif", proportionalSerif: "serif", casual: '"Comic Sans MS", Impact, fantasy', script: '"Monotype Corsiva", cursive', smallcaps: '"Andale Mono", "Lucida Console", monospace, sans-serif'}, Xr = function (t) {
        function e(n, r, i) {
            Ie(this, e);
        ...
        return De(e, t), e.prototype.preselectTrack = function () {
            for (var t = {captions: 1, subtitles: 1}, e = this.player_.textTracks(), n = this.player_.cache_.selectedLanguage, r = void 0, i = void 0, o = void 0, s = 0; s < e.length; s++) {
                var a = e[s];
    ...
    var Kr = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function (t) {
            ...
            t = "button", e = r({innerHTML: '<span aria-hidden="true" class="vjs-icon-placeholder"></span>', className: this.buildCSSClass()}, e), n = r({type: "button", "aria-live": "polite"}, n);
    ...
    var Jr = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            return this.contentEl_ = f("div", {className: "vjs-current-time-display"}, {"aria-live": "off"}, f("span", {className: "vjs-control-text", textContent: this.localize("Current Time")})), this.updateTextNode_(), e.appendChild(this.contentEl_), e
            ...
            var e = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime(), n = Gt(e, this.player_.duration());
    ...
    var Qr = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            return this.contentEl_ = f("div", {className: "vjs-duration-display"}, {"aria-live": "off"}, f("span", {className: "vjs-control-text", textContent: this.localize("Duration Time")})), this.updateTextNode_(),
    ...
    var ti = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            return this.contentEl_ = f("div", {className: "vjs-remaining-time-display"}, {"aria-live": "off"}, f("span", {className: "vjs-control-text", textContent: this.localize("Remaining Time")})), this.updateTextNode_(), e.appendChild(this.contentEl_), e
        }, e.prototype.updateTextNode_ = function () {
            this.textNode_ && this.contentEl_.removeChild(this.textNode_), this.textNode_ = ce.createTextNode(" -" + (this.formattedTime_ || "0:00")), this.contentEl_.appendChild(this.textNode_)
        }, e.prototype.updateContent = function (t) {
    ...
    var ei = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            return this.contentEl_ = f("div", {className: "vjs-live-display", innerHTML: '<span class="vjs-control-text">' + this.localize("Stream Type") + "</span>" + this.localize("LIVE")}, {"aria-live": "off"}), e.appendChild(this.contentEl_), e
    ...
    var ni = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function (e) {
            ...
            return n.className = n.className + " vjs-slider", n = r({tabIndex: 0}, n), i = r({role: "slider", "aria-valuenow": 0, "aria-valuemin": 0, "aria-valuemax": 100, tabIndex: 0}, i), t.prototype.createEl.call(this, e, n, i)
        }, e.prototype.handleMouseDown = function (t) {
    ...
    var ri = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            var e = this.player_.buffered(), n = this.player_.duration(), r = this.player_.bufferedEnd(), i = this.partEls_, o = function (t, e) {
                var n = t / e || 0;
                return 100 * (n >= 1 ? 1 : n) + "%"
            };
    ...
    var oi = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            this.rafId_ && this.cancelAnimationFrame(this.rafId_), this.rafId_ = this.requestAnimationFrame(function () {
                var r = n.player_.scrubbing() ? n.player_.getCache().currentTime : n.player_.currentTime(), i = Gt(r, n.player_.duration()), o = n.getChild("timeTooltip");
                o && o.update(t, e, i)
            })
        }, e
    }(bn);
    ...
    var ai = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            var e = t.prototype.update.call(this), n = this.player_.duration(), r = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime();
            ...
            var t = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime(), e = t / this.player_.duration();
            return e >= 1 ? 1 : e
    ...
    ai.prototype.options_ = {children: ["loadProgressBar", "playProgressBar"], barName: "playProgressBar"}, xe && !(xe > 8) || ye || me || ai.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"), ai.prototype.playerEvent = "timeupdate", bn.registerComponent("SeekBar", ai);
    var li = function (t) {
        function e(n, r) {
            Ie(this, e);
            var i = Le(this, t.call(this, n, r));
    ...
    pi.prototype.options_ = {children: ["volumeLevel"], barName: "volumeLevel"}, pi.prototype.playerEvent = "volumechange", bn.registerComponent("VolumeBar", pi);
    var di = function (t) {
        function e(n) {
    ...
    var _i = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function (e, n, i) {
            return this.nonIconControl = !0, t.prototype.createEl.call(this, "li", r({className: "vjs-menu-item", innerHTML: '<span class="vjs-menu-item-text">' + this.localize(this.options_.label) + "</span>", tabIndex: -1}, n), i)
        }, e.prototype.handleClick = function (t) {
            this.selected(!0)
    ...
    var Ti = function (t) {
        function e(n, r) {
            Ie(this, e), r.track = {player: n, kind: r.kind, kinds: r.kinds, default: !1, mode: "disabled"}, r.kinds || (r.kinds = [r.kind]), r.label ? r.track.label = r.label : r.track.label = r.kinds.join(" and ") + " off", r.selectable = !0;
            var i = Le(this, t.call(this, n, r));
    ...
    var Ci = function (t) {
        ...
        return De(e, t), e.prototype.createItems = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : bi, n = void 0;
            this.label_ && (n = this.label_ + " off"), t.push(new Ti(this.player_, {kinds: this.kinds_, kind: this.kind_, label: n})), this.hideThreshold_ += 1;
    ...
    var xi = function (t) {
        function e(n, r) {
            Ie(this, e), r.track = {player: n, kind: r.kind, label: r.kind + " settings", selectable: !1, default: !1, mode: "disabled"}, r.selectable = !1, r.name = "CaptionSettingsMenuItem";
            var i = Le(this, t.call(this, n, r));
    ...
    var Ii = function (t) {
        ...
        return De(e, t), e.prototype.createEl = function () {
            ...
            return this.labelEl_ = f("div", {className: "vjs-playback-rate-value", innerHTML: "1x"}), e.appendChild(this.labelEl_), e
        }, e.prototype.buildCSSClass = function () {
    ...
    Bi.prototype.options_ = Q(In.prototype.options_, {pauseOnOpen: !1, fillAlways: !0, temporary: !1, uncloseable: !0}), bn.registerComponent("ErrorDisplay", Bi);
    var Fi = ["#000", "Black"], Vi = ["#00F", "Blue"], Hi = ["#0FF", "Cyan"], Wi = ["#0F0", "Green"], Ui = ["#F0F", "Magenta"], zi = ["#F00", "Red"], Xi = ["#FFF", "White"], qi = ["#FF0", "Yellow"], Ki = ["1", "Opaque"], Yi = ["0.5", "Semi-Transparent"], Gi = ["0", "Transparent"], $i = {
        backgroundColor: {selector: ".vjs-bg-color > select", id: "captions-background-color-%s", label: "Color", options: [Fi, Xi, zi, Wi, Vi, qi, Ui, Hi]},
        backgroundOpacity: {selector: ".vjs-bg-opacity > select", id: "captions-background-opacity-%s", label: "Transparency", options: [Ki, Yi, Gi]},
        color: {selector: ".vjs-fg-color > select", id: "captions-foreground-color-%s", label: "Color", options: [Xi, Fi, zi, Wi, Vi, qi, Ui, Hi]},
        ...
        fontPercent: {
            selector: ".vjs-font-percent > select", id: "captions-font-size-%s", label: "Font Size", options: [["0.50", "50%"], ["0.75", "75%"], ["1.00", "100%"], ["1.25", "125%"], ["1.50", "150%"], ["1.75", "175%"], ["2.00", "200%"], ["3.00", "300%"], ["4.00", "400%"]], default: 2, parser: function (t) {
                return "1.00" === t ? null : Number(t)
            }
        },
        textOpacity: {selector: ".vjs-text-opacity > select", id: "captions-foreground-opacity-%s", label: "Transparency", options: [Ki, Yi]},
        windowColor: {selector: ".vjs-window-color > select", id: "captions-window-color-%s", label: "Color"},
        windowOpacity: {selector: ".vjs-window-opacity > select", id: "captions-window-opacity-%s", label: "Transparency", options: [Gi, Yi, Ki]}
    };
    ...
    var Ji = function (t) {
        function r(n, i) {
            ...
            return o.updateDisplay = ln(o, o.updateDisplay), o.fill(), o.hasBeenOpened_ = o.hasBeenFilled_ = !0, o.endDialog = f("p", {className: "vjs-control-text", textContent: o.localize("End of dialog window.")}), o.el().appendChild(o.endDialog), o.setDefaults(), void 0 === i.persistTextTrackSettings && (o.options_.persistTextTrackSettings = o.options_.playerOptions.persistTextTrackSettings), o.on(o.$(".vjs-done-button"), "click", function () {
        ...
        return De(r, t), r.prototype.createElSelect_ = function (t) {
            var e = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "label", i = $i[t], o = i.id.replace("%s", this.id_);
            ...
            return f("div", {className: 'vjs-track-settings-font">', innerHTML: ['<fieldset class="vjs-font-percent vjs-track-setting">', this.createElSelect_("fontPercent", "", "legend"), "</fieldset>", '<fieldset class="vjs-edge-style vjs-track-setting">', this.createElSelect_("edgeStyle", "", "legend"), "</fieldset>", '<fieldset class="vjs-font-family vjs-track-setting">', this.createElSelect_("fontFamily", "", "legend"), "</fieldset>"].join("")})
        }, r.prototype.createElControls_ = function () {
            var t = this.localize("restore all settings to the default values");
            return f("div", {className: "vjs-track-settings-controls", innerHTML: ['<button class="vjs-default-button" title="' + t + '">', this.localize("Reset"), '<span class="vjs-control-text"> ' + t + "</span>", "</button>", '<button class="vjs-done-button">' + this.localize("Done") + "</button>"].join("")})
        ...
        return De(e, t), e.prototype.dispose = function () {
            ...
            if (!t || !this.options_.playerElIngest && !this.movingMediaElementInDOM) {
                if (t) {
                    ...
                    Pe && !0 === this.options_.nativeControlsForTouch || delete o.controls, T(t, r(o, {id: this.options_.techId, class: "vjs-tech"}))
                }
    ...
    var eo = Zi.TEST_VID && Zi.TEST_VID.constructor.prototype.canPlayType, no = /^application\/(?:x-|vnd\.apple\.)mpegurl/i, ro = /^video\/mp4/i;
    ...
    var io = Re(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
        oo = ["progress", "abort", "suspend", "emptied", "stalled", "loadedmetadata", "loadeddata", "timeupdate", "ratechange", "resize", "volumechange", "texttrackchange"], so = function (t) {
            ...
            return De(e, t), e.prototype.dispose = function () {
                ...
                var e = this.tag, n = void 0, r = this.playerElIngest_ = e.parentNode && e.parentNode.hasAttribute && e.parentNode.hasAttribute("data-vjs-player");
