    ...
    $
        ...
        .extend({
            Breadcrumb: function () {
                ...
                function loadBreadcrumb(shareRootId) {
                    var url = host + '/ufm/api/v2/nodes/' + ownerId + '/' + catalogParentId + "/path?rootId=" + shareRootId;
                    $.ajax({
                        type: 'GET',
                        url: url,
                        cache: false,
                        async: true,
                        timeout: 180000,
                        // url: ctx + '/share/getPaths/' + ownerId + '/' + shareRootId,
                ...
                self.load = function (shareRootId) {
                    _items = []
                    loadBreadcrumb(shareRootId)
                }
