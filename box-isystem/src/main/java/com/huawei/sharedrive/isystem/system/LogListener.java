package com.huawei.sharedrive.isystem.system;
...
public class LogListener implements ConfigListener
{
    ...
    public void init()
    {
        ...
        limit.setOffset(0l);
        limit.setLength(1);
        List<SystemConfig> enalbeConfigList = systemConfigDAO.getByPrefix(limit,
            LogLanguage.USER_LOG_ISCONFIG);
        ...
        List<SystemConfig> langConfigList = systemConfigDAO.getByPrefix(limit,
            LogLanguage.USER_LOG_CONFIG_LANGUAGE);
    ...
    private static void setEnable(String input)
    {
        enable = input;
    }
    
    private static void setLanguage(String input)
    {
        language = input;
    }
