...
<input type="hidden" id="clusterId" name="clusterId" value="${cse:htmlEscape(clusterId)}"/>
	...
	<div class="form-horizontal form-con clearfix">
		<div class="form-left">
	        <div class="control-group">
	            <label for="input" class="control-label"><spring:message code="log.clusterNode"/></label>
	            <div class="controls">
	        ...
	        <div class="control-group">
	            <label for="input" class="control-label"><spring:message code="log.fileName"/></label>
	            <div class="controls">
