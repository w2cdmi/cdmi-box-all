	...
	<div class="form-horizontal form-con clearfix">
   	<form id="mailServerForm" name="mailServerForm" class="form-horizontal" method="post" action="${ctx}/sysconfig/mailserver/save">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span4" type="text" id="server" name="server" value="${cse:htmlEscape(mailServer.server)}" />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span4" type="text" id="senderName" name="senderName" value="${cse:htmlEscape(mailServer.senderName)}" />
                <span class="validate-con"><div></div></span>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group" id="authUsernameDiv" <c:if test="${!mailServer.enableAuth}">style="display:none"</c:if>>
            ...
            <div class="controls">
                <input class="span4" type="text" id="authUsername" name="authUsername" value="${cse:htmlEscape(mailServer.authUsername)}" />
                <span class="validate-con"><div></div></span>
            </div>
        </div>
