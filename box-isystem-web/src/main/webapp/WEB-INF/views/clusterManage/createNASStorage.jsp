	...
	<div class="form-con">
   	<form class="form-horizontal" id="creatStorageForm">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="path" class="span4" name="path" />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="maxUtilization" class="span4" name="maxUtilization" value="60"/>&nbsp;%
                <span class="validate-con bottom"><div></div></span>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="retrieval" class="span4" name="retrieval" value="50"/>&nbsp;%
                <span class="validate-con bottom"><div></div></span>
...
function submitStorage() {
	...
	inLayerLoading('<spring:message code="cluster.createStorage.loading"/>',"loading-bar");
	$.ajax({
        type: "POST",
        url:"${ctx}/cluster/dcdetailmanage/createNASStorage",
