...
#define DUI_MSGTYPE_NEXTPAGE			   (_T("nextPage"))
#define DUI_MSGTYPE_LASTPAGE			   (_T("lastPage"))
...
#define  DUI_CTR_RICHEDITUI                      (_T("RichEditUI"))
...
#define  DUI_CTR_ROUNDGIF						 (_T("RountGif"))
...
#ifndef PAINT_BORDER_TIMER
#define PAINT_BORDER_TIMER (10000)
#endif
