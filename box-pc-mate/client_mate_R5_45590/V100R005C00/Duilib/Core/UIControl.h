...
public:
	...
	// 获取文本超长时自动省略的文本
	virtual CDuiString GetEndellipsisText(LPCTSTR pstrText, int maxWidth, int font = 14) const;
	// 获取文本宽度
	virtual int GetTextWidth(LPCTSTR pstrText, int font = 14) const;
	...
	void SetContextMenu(CContextMenuUI* pMenu);
	CContextMenuUI* GetContextMenu();
	...
	virtual void SetDropEnabled(bool bDrop);  //拖拽属性  2015.3.6
	bool IsDropEnabled();
...
protected:
    ...
    RECT m_rcPaint;
	RECT m_rcBorderSize;
	bool m_bDragEnabled;  //拖拽属性  2015.3.6
