...
namespace DuiLib {
	...
	{
		m_nMoveSpeed = TAB_ANIMATION_ELLAPSE;
	}
	...
	void CAnimationTabLayoutUI::AnimationSwitch()
	{
		...
		StartAnimation( m_nMoveSpeed, TAB_ANIMATION_FRAME_COUNT, TAB_ANIMATION_ID );
	}
	...
	void CAnimationTabLayoutUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if( _tcscmp(pstrName, _T("animation_speed")) == 0) m_nMoveSpeed = _ttoi(pstrValue);
