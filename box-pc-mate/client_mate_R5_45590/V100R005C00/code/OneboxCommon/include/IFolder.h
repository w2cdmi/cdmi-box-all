...
typedef std::list<FILE_DIR_INFO> LIST_FOLDER_RESULT;
...
public:
	...
	virtual FILE_DIR_INFO property(const PROPERTY_MASK& mask = PROPERTY_MASK_ALL)
	{
		...
		if (PROPERTY_EXTRATYPE & mask)
			property.extraType = property_.extraType;
		return property;
	}
	...
	virtual int32_t create(FOLDER_EXTRA_TYPE extraType, const bool autoMerge) {return RT_NOT_IMPLEMENT;}
