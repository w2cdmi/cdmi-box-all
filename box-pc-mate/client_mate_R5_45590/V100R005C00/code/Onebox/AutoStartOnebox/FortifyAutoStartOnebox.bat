...
REM Created on 2015/09/24 16:53:23
REM ###########################################################################
...
set ARGFILE="FortifyAutoStartOnebox.bat.args"
set MEMORY=-Xmx1200M -Xms600M -Xss24M 
set LAUNCHERSWITCHES=""
set OLDFILENUMBER=FortifyAutoStartOnebox.bat.fileno
set FILENOMAXDIFF=10
set DEVENV="C:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\devenv"

set PROJECTROOT0="D:\build\test\code\current\clent_v2\projects\client\pc\V100R005C00\code\Onebox\AutoStartOnebox"
...
echo. >FortifyAutoStartOnebox.bat.args
...
%SOURCEANALYZER% %MEMORY% %LAUNCHERSWITCHES% -b %BUILDID%  %DEVENV%  "D:\build\test\code\current\clent_v2\projects\client\pc\V100R005C00\code\Onebox\AutoStartOnebox\AutoStartOnebox.sln" /REBUILD Release
