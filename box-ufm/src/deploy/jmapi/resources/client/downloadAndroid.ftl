...
.logo{ padding-top:125px; height:220px; background:url(../skins/default/img/logo-big-blue.png) no-repeat center bottom;}
...
<div class="logo"></div>
<div id="zh">
	<h1>华为云盘 Android 版</h1>
	<div class="btn-con"><a href="${urlPrefix}clientapp/Huawei_CloudDrive_${version}.apk">立即下载</a></div>
	<p>大小 : ${size}</p>
	<p>版本 : ${version}</p>
	<p>适用系统 : ${supportSys}</p>
...
<div id="en">
	<h1>OneBox (Android)</h1>
	<div class="btn-con"><a href="${urlPrefix}clientapp/Huawei_CloudDrive_${version}.apk">Download Now</a></div>
	<p>Size : ${size}</p>
	<p>Version : ${version}</p>
	<p>Applicable to : ${supportSys}</p>
