package com.huawei.sharedrive.app.common.systemtask.dao.impl;
...
public class SystemTaskDAOImpl extends AbstractDAOImpl implements SystemTaskDAO
{
    ...
    @SuppressWarnings("deprecation")
    @Override
    public SystemTask getOneWaitingExeTaskAndLock(SystemTask task)
    {
        return (SystemTask) sqlMapClientTemplate.queryForObject("SystemTask.getOneTaskByTaskIdAndLock", task);
    }
    ...
    {
        return (null != sqlMapClientTemplate.queryForObject("SystemTask.checkExistingTask", pTask));
    ...
    {
        return (long) sqlMapClientTemplate.queryForObject("SystemTask.getSystemTaskTotalsByTaskKeyAndState", task);
    }
