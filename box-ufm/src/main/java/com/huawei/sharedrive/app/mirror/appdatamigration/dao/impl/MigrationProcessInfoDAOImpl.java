...
public class MigrationProcessInfoDAOImpl extends AbstractDAOImpl implements MigrationProcessInfoDAO
{
    ...
    {
        return (MigrationProcessInfo)sqlMapClientTemplate.queryForObject("MigrationProcessInfo.getLastUnDoneMigrationProcess",processInfo);
    }
    ...
    {
        sqlMapClientTemplate.update("MigrationProcessInfo.updateMigrationProcessForCompleteFile", migrationProcessInfo);
    }
    ...
    {
        return sqlMapClientTemplate.queryForList("MigrationProcessInfo.lstAllMigrationProcessInfoByPolicyId",policyId);
    }
