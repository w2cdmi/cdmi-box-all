...
public class NodeStatisticsCurrentTest extends BaseAPITest
{
    
    private static final String FILE = "testData/statistics/NodeStatisticsCurrentTest.txt";
    
    
    private static final String url = "statistics/nodes/current";
