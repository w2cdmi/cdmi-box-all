...
public class ObjectStatisticsHistoryTest extends BaseAPITest
{
    
    private static final String FILE = "testData/statistics/ObjectStatisticsHistoryTest.txt";
    
    private static final String url = "statistics/objects/history";
