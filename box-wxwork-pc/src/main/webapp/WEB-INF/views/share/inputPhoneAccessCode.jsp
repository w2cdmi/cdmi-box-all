                ...
                <form class=" form-horizontal" id="mailForm" name="mailForm" action="sendAccessCode" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <button type="button" onclick="sendAccessCode()" class="btn"><spring:message code="button.obtain"/></button>
                            <span class="help-block"><spring:message code="input.rightPhoneobtainCode"/></span>
                        </div>
                    </div>
                </form>
                <form class=" form-horizontal" id="accessCodeForm" name="accessCodeForm" action="${ctx}/share/inputAccessCode" method="post">
                    <input type="hidden" id="linkCode" name="linkCode" value="<c:out value='${linkCode}'/>"/>
                    <div class="control-group">
                        <label class="control-label" for=""><em>*</em><spring:message code="link.label.accessCode"/>:
                        </label>
                        <div class="controls">
                            <input type="text" id="accessCode" name="accessCode" class="span3 required" maxlength="20"/>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <img title='<spring:message code="link.toChangeCaptcha" />' id="img_captcha" onclick="javascript:loadimage();" src="${ctx}/verifycode">
                            (<spring:message code="link.notSeeCaptcha"/>
                            <a href="javascript:void(0)" onclick="javascript:loadimage()"><spring:message code="link.changeCaptcha"/></a>)
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
