            ...
            function loadpersonlists() {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //     if(teamType == '1') {
                        //
                        //         if(usersData[i].userType == 'department') {
                        //
                        //             // continue;
                        //             return
                        //         }
                        //     }
                        //     if (usersData[i].userType == 'user') {
                        //         url = ctx + '/userimage/getUserImage/' + usersData[i].userId
                        //         name = usersData[i].username
                        //     } else if (usersData[i].userType == 'department') {
                        //         url = ctx + '/static/skins/default/img/department-icon.png'
                        //         name = usersData[i].username
                        //     }
                        //     roles= getRoleList(usersData[i].role,usersData[i].teamRole)
