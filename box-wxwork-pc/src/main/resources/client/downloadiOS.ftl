...
<div id="zh">
	<h1>iOS 客户端</h1>
	<div class="btn-con"><a href="${iosDownloadUrl}">立即下载</a></div>
	<p>大小 : ${iosSize}</p>
	<p>版本 : ${iosVersion}</p>
	<p>适用系统 : ${iosSupportSys}</p>
	
	<p class="lang"><a onclick="switchLang('en')" href="#none">English</a></p>
</div>
<div id="en">
	<h1>iOS client</h1>
	<div class="btn-con"><a href="${iosDownloadUrl}">Download Now</a></div>
	<p>Size : ${iosSize}</p>
	<p>Version : ${iosVersion}</p>
	<p>Applicable to : ${iosSupportSys}</p>
