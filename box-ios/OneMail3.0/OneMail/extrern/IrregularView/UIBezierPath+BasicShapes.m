...
+ (UIBezierPath *)userShape:(CGRect)originalFrame
{
	...
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.68031 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.39072 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.65233 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.44503 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.6744 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.42087 * CGRectGetHeight(frame))];
	...
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.50277 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4892 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.55205 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.11518 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.53038 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4965 * CGRectGetHeight(frame))];
	[bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 0.50277 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4878 * CGRectGetHeight(frame))];
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.50036 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4887 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.50197 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4878 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.50116 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4886 * CGRectGetHeight(frame))];
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.49633 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4878 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.49901 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4885 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.49772 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4878 * CGRectGetHeight(frame))];
	[bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 0.49639 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4902 * CGRectGetHeight(frame))];
	...
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.31879 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.39072 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.32734 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.34552 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.3453 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.35062 * CGRectGetHeight(frame))];
	...
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.40188 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.53216 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.3843 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.47851 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.38642 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.51696 * CGRectGetHeight(frame))];
	...
	[bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.05796 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.77326 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.1145 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.72870 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.05796 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.75592 * CGRectGetHeight(frame))];
...
+ (UIBezierPath *)martiniShape:(CGRect)originalFrame
{
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.3044 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.18650 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.29961 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.19119 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.30032 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.18885 * CGRectGetHeight(frame))];
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.26643 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.17965 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.27974 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.1774 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.27297 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.17908 * CGRectGetHeight(frame))];
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.20197 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.03639 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.2461 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.05770 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.2421 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.04776 * CGRectGetHeight(frame))];
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.32127 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15045 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.33827 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4174 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.33652 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.1274 * CGRectGetHeight(frame))];
...
+ (UIBezierPath *)beakerShape:(CGRect)originalFrame
{
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.72503 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.52522 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.72623 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.5254 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.72565 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.52522 * CGRectGetHeight(frame))];
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.38337 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.17174 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.3947 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.06571 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.38277 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.4648 * CGRectGetHeight(frame))];
...
+ (UIBezierPath *)bubbleShape:(CGRect)originalFrame direct:(NSInteger)direct{
    CGPoint origin = originalFrame.origin;
    CGFloat origin_x = origin.x;
    CGFloat origin_y = origin.y;
    UIBezierPath *path = [[UIBezierPath alloc] init];
    if (direct == 1) {
        [path addArcWithCenter:CGPointMake(origin_x + 4, origin_y + 4) radius:4 startAngle:1.5 * pi endAngle:pi clockwise:NO];
        [path addLineToPoint:CGPointMake(origin_x, origin_y + 15)];
        [path addLineToPoint:CGPointMake(origin_x - 8, origin_y + 20)];
        [path addLineToPoint:CGPointMake(origin_x, origin_y + 25)];
        [path addLineToPoint:CGPointMake(origin_x, origin_y + originalFrame.size.height - 4)];
        [path addArcWithCenter:CGPointMake(origin_x + 4, origin_y + originalFrame.size.height - 4) radius:4 startAngle:pi endAngle:0.5 * pi clockwise:NO];
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width - 4, origin_y + originalFrame.size.height)];
        [path addArcWithCenter:CGPointMake(origin_x + originalFrame.size.width - 4, origin_y + originalFrame.size.height - 4) radius:4 startAngle:0.5 * pi endAngle:0 clockwise:NO];
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width, origin_y + 4)];
        [path addArcWithCenter:CGPointMake(origin_x + originalFrame.size.width - 4, origin_y + 4) radius:4 startAngle:0 endAngle:1.5 * pi clockwise:NO];
        ...
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width - 4, origin_y + originalFrame.size.height)];
        [path addArcWithCenter:CGPointMake(origin_x + originalFrame.size.width - 4, origin_y + originalFrame.size.height - 4) radius:4 startAngle:0.5 * pi endAngle:0 clockwise:NO];
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width, origin_y + 25)];
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width + 8, origin_y + 20)];
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width, origin_y + 15)];
        [path addLineToPoint:CGPointMake(origin_x + originalFrame.size.width, origin_y + 4)];
        [path addArcWithCenter:CGPointMake(origin_x + originalFrame.size.width - 4, origin_y + 4) radius:4 startAngle:0 endAngle:1.5 * pi clockwise:NO];
        [path addLineToPoint:CGPointMake(origin_x + 4, origin_y)];
    }
