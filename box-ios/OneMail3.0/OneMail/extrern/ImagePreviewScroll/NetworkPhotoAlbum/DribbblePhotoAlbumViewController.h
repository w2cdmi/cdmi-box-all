...
@interface DribbblePhotoAlbumViewController : NetworkPhotoAlbumViewController <
  NIPhotoAlbumScrollViewDataSource,NIOperationDelegate>{
  @private
      NSMutableArray *pathArray;
      NSMutableArray *fileArray;
      NSMutableArray *versionArray;
      int currentPathIndex;
      NSString *contasinName;
      NSMutableArray *transportArray;
}

@property (nonatomic,strong) File *previewFile;
@property (nonatomic,strong) Version *previewVersion;
