...
/* Commented as this is useless code and will never be true in any of the platforms.
 * and more over, this will generate gcc warning if we use -Wundef as #ifdef
 * should not be used to compare any values other than macros.
 * There is no impact to the user by commenting this code
#if LAST_SYM_ALG != CID_RC2_CFB   
# error "Inconsistency between sec_crypto.h and ipsi_algid_to_g_AlgTable_idx"
#endif
Comment end for useless code */
...
*
* @retval SEC_UINT32 On successful set of seed [SEC_SUCCESS|N/A].   
* @retval SEC_UINT32 If pSeed is NULL or ulLen is 0 
[SEC_ERR_INVALID_ARG|N/A].          
* @retval SEC_UINT32 If the hardware mode is set 
[SEC_HW_ERR_INVALID_OPERATION|N/A].
*
...
*
* @par Description
* CRYPT_saveRandState function saves the random number genrator 
...
/*
    Func Name:  CRYPT_ssx31b_linux_Init
*/

/**
* @defgroup CRYPT_ssx31b_linux_Init
* @ingroup HLF High Level Functions
* @par Prototype
* @code
* SEC_UINT32 CRYPT_ssx31b_linux_Init(
* const SEC_CHAR* deviceName);
* @endcode
*
* @par Purpose
* This is used to initialize SSX31B HW in the linux environment.
*
* @par Description
* CRYPT_ssx31b_linux_Init function initializes SSX31B HW 
in the linux environment.
*
* @param[in] deviceName The device name with its path to be initialized [N/A]
*
* @retval SEC_UINT32 If device is ready for use [SEC_SUCCESS|N/A]
* @retval SEC_UINT32 Invalid Arguments [SEC_ERR_INVALID_ARG|N/A]
* @retval SEC_UINT32 If device cannot be initialized [SEC_ERR|N/A]
* @retval SEC_UINT32 No such device or directory [SEC_HW_ERR_FILENAME|N/A]
* @retval SEC_UINT32 No permission to use the device 
[SEC_HW_ERR_PERMISSION|N/A]
* @retval SEC_UINT32 The device not availabe 
/ cannot be used [SEC_HW_ERR_DEVICE|N/A]
* @retval SEC_UINT32 If some library error 
[SEC_ERR_INVALID_ATTR|Contact vendor]
*
* @par Required Header File
* sec_crypto.h
*
...
//CRYPTOLINKDLL SEC_UINT32 CRYPT_ssx31b_linux_Init(
//  const SEC_CHAR* deviceName);


/*
    Func Name:  CRYPT_ssx31b_vxworks_Init
*/

/**
* @defgroup CRYPT_ssx31b_vxworks_Init
* @ingroup HLF High Level Functions
* @par Prototype
* @code
* SEC_UINT32 CRYPT_ssx31b_vxworks_Init();
* @endcode
*
* @par Purpose
* This is used to initialize SSX31B HW in the VxWorks environment.
*
* @par Description
* CRYPT_ssx31b_vxworks_Init function initializes SSX31B 
HW in the VxWorks environment.
*
* @par Parameters
* N/A
*
...
CRYPTOLINKDLL SEC_UINT32 CRYPT_ssx31b_vxworks_Init();


/*
    Func Name:  CRYPT_ssx31bFinalize
*/

/**
* @defgroup CRYPT_ssx31bFinalize
* @ingroup HLF High Level Functions
* @par Prototype
* @code
* SEC_UINT32 CRYPT_ssx31bFinalize();
* @endcode
*
* @par Purpose
* This is used to stop the HW and switch back to SW.
*
* @par Description
* CRYPT_ssx31bFinalize function stops the HW and switch back to SW.
*
* @par Parameters
* N/A
*
* @retval SEC_UINT32 If device is turned off successfully 
[SEC_SUCCESS|N/A]
* @retval SEC_UINT32 If device cannot be closed 
[SEC_HW_ERR_CLOSE|Continue working in HW mode]
*
* @par Required Header File
* sec_crypto.h
*
...
//CRYPTOLINKDLL SEC_UINT32 CRYPT_ssx31bFinalize();


/*
    Func Name:  CRYPT_usbkeyInit
*/

/**
* @defgroup CRYPT_usbkeyInit
* @ingroup HLF High Level Functions
* @par Prototype
* @code
* SEC_UINT32 CRYPT_usbkeyInit(
* const SEC_CHAR* pcContainer,
* const SEC_CHAR* pcProvider,
* SEC_BOOL bCreateFlag);
* @endcode
*
* @par Purpose
* This is used to initialize USBKEY for usage.
*
* @par Description
* CRYPT_usbkeyInit function initializes USBKEY for usage.
*
* @param[in] pcContainer The Container name to open or create [N/A]
* @param[in] pcProvider The USBKEY provider name [N/A]
* @param[in] bCreateFlag If this flag is set, 
then a new key container will be created with the name specified by
* pcContainer [N/A]
*
* @retval SEC_UINT32 If device is ready for use [SEC_SUCCESS|N/A]
* @retval SEC_UINT32 Invalid Arguments [SEC_ERR_INVALID_ARG|N/A]
* @retval SEC_UINT32 If device cannot be initialized [SEC_ERR_INITDEVICE|N/A]
* @retval SEC_UINT32 If error in device [SEC_HW_ERR_DEVICE|N/A]
*
* @par Required Header File
* sec_crypto.h
*
...
/*CRYPTOLINKDLL SEC_UINT32 CRYPT_usbkeyInit(
    const SEC_CHAR* pcContainer,
    const SEC_CHAR* pcProvider,
    SEC_BOOL        bCreateFlag);
*/
...
/*
    Func Name:  CRYPT_usbkeyFinalize
*/

/**
* @defgroup CRYPT_usbkeyFinalize
* @ingroup HLF High Level Functions
* @par Prototype
* @code
* SEC_UINT32 CRYPT_usbkeyFinalize();
* @endcode
*
* @par Purpose
* This is used to stop using USBKEY.
*
* @par Description
* CRYPT_usbkeyFinalizes function stops using USBKEY.
*
* @par Parameters
* N/A
*
* @retval SEC_UINT32 If device is turned off successfully [SEC_SUCCESS|N/A]
* @retval SEC_UINT32 If device cannot be closed
[SEC_HW_ERR_CLOSE|Continue working in HW mode]
*
* @par Required Header File
...
//CRYPTOLINKDLL SEC_UINT32 CRYPT_usbkeyFinalize();


/*
 Func Name:  CRYPT_destroyContainer
*/

/**
* @defgroup CRYPT_destroyContainer
* @ingroup HLF High Level Functions
* @par Prototype
* @code
* SEC_UINT32 CRYPT_destroyContainer(
* const SEC_CHAR* pcContainerName,
* const SEC_CHAR* pcProviderName,
* SEC_BOOL bForceDestroy);
* @endcode
*
* @par Purpose
* This is used to destroy the specified container from the CSP mentioned.
*
* @par Description
* CRYPT_destroyContainer function destroys the
specified container from the CSP mentioned.
*
* @param[in] pcContainerName The Container name to destroy [N/A]
* @param[in] pcProviderName The USBKEY provider name [N/A]
* @param[in] bForceDestroy If this flag is set, 
then the container is forced to destroy even if it is under usage.
* This action will stop usage of the USB-KEY [N/A]
*
* @retval SEC_UINT32 If operation is successful [SEC_SUCCESS|N/A]
* @retval SEC_UINT32 Invalid Arguments [SEC_ERR_INVALID_ARG|N/A]
* @retval SEC_UINT32 If cannot destroy the container [SEC_HW_ERR_DEVICE|N/A]
* @retval SEC_UINT32 The Container is currently in
use and cannot be destroyed [SEC_HW_ERR_INVALID_OPERATION|N/A]
*
* @par Required Header File
* sec_crypto.h
*
...
CRYPTOLINKDLL SEC_UINT32 CRYPT_destroyContainer(
    const SEC_CHAR* pcContainerName,
    const SEC_CHAR* pcProviderName,
    SEC_BOOL        bForceDestroy);
