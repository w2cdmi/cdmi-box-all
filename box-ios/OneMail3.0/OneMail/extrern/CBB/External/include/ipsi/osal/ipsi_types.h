...
//#if defined(WIN32)
//#define SEC_vsnprintf _vsnprintf
#define SEC_vsnprintf ipsi_vsnprintf

//#else
//#define SEC_vsnprintf vsnprintf
//#endif
...
//#if defined(WIN32)
//#define SEC_snprintf _snprintf
#define SEC_snprintf ipsi_snprintf

//#else
//#define SEC_snprintf snprintf
//#endif 

//#ifdef SEC_STR_CASE
//#define SEC_StrNiCmp strncasecmp
//#define SEC_StrICmp strcasecmp
//#else 
//#define SEC_StrNiCmp _strnicmp
//#define SEC_StrICmp _stricmp
...
#define SEC_MEM_REALLOC(pOldMemPtr,ulNewSize) \
        ipsi_realloc(pOldMemPtr,ulNewSize) /*!< To reallocate memory */

/*!<To set memory block to 0s. Uses Dopra function*/
...
/*!<To copy a memory block. Uses Dopra function*/
#define SEC_MEM_CPY(pDest,pSrc,ulCount) \
        ipsi_memcpy(pDest,pSrc,ulCount ) 


/* convert initial portion of the string pointed to by str to plnum */
/*#define SEC_StrToUint32(str,plnum)\
    (((plnum) && (*(plnum) = atol(str)) >= 0)?SEC_SUCCESS:-1)*/
#define SEC_StrToUint32(str,plnum)\
