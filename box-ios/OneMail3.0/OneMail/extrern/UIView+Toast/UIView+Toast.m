...
// shadow appearance
static const CGFloat CSToastShadowOpacity       = 0.3;
...
static const NSTimeInterval CSToastDefaultDuration  = 0.5;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (message != nil) {
        ...
        messageLabel.frame = CGRectMake(0.0, 0.0, expectedSizeMessage.width, expectedSizeMessage.height+20);
    }
    ...
    if(titleLabel != nil) {
        ...
        titleLeft = imageLeft + imageWidth + CSToastVerticalPadding + (messageLabel.frame.size.width-titleWidth)/2;
    } else {
    ...
    CGFloat wrapperWidth = MAX((imageWidth + (CSToastHorizontalPadding * 2)), (longerWidth + CSToastHorizontalPadding * 2));
