//
//  CloudSpaceDetailTableViewCell.m
//  OneMail
//
...
@interface CloudSpaceDetailTableViewCell ()
...
@implementation CloudSpaceDetailTableViewCell
...
- (UIImageView*)fileDownloadImageView {
    if (!_fileDownloadImageView) {
        ...
        _fileDownloadImageView.image = [UIImage imageNamed:@"ic_list_image_download"];//ic_list_image_download//ic_transfer_upload
    }
