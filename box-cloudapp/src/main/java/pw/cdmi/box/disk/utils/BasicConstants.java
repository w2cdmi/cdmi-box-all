...
public class BasicConstants
{
    ...
    public static final String RESOURCE_TOKEN_CREATE_V2 = "/api/v2/users/";
    
    public static final String RESOURCE_FILE = "/api/v2/files";
    
    public static final String RESOURCE_FILE_HISTORY = "/api/wxmp/files";
    ...
    public final static long SINGLE_FILEPART_MAXSIZE = 1024 * 1024 * 5;
    ...
    public static final String RESOURCE_FOLDER = "/api/v2/folders";
    
    public static final String UFM_RESOURCE_BIND_FILELABEL = "/api/v2/fl";
    
    public static final String UFM_RESOURCE_DOCTYPE = "/api/v2/doctype";
}
