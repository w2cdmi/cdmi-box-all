	        ...
	        <%--<div class="share-homepage-header">--%>
				...
				<%--<div class="share-homepage-right">--%>
					...
					<%--<div class="share-homepage-bottom">--%>
						<%--<div class="share-homepage-bottom-size"><div id="fileSize"></div></div>--%>
						<%--<div class="file-createByName" id="file-createByName"></div>--%>
						<%--<div class="file-createTime" id="file-createTime"></div>--%>
					<%--</div>--%>
				<%--</div>--%>
                    ...
                    <div class="weui-cell weui-cell-change">
                        <div class="weui-cell__bd" >
                            <div class="index-recent-left">
                                <div id="fileIcon" class="file-png"></div>
                            </div>
