...
<div class="box">
    <div class="link-header">
        ...
        <span class="logo-name"><spring:message code='main.title'/></span>
    </div>
...
<script id="fileTemplate" type="text/template7">
    <div class="file line-content" id="file_{{id}}" style="border-bottom: 0.05rem solid #E4E1E1;" onclick="optionInode(this)">
        <div class="file-info">
