...
<body>
	<div class="sys-content sys-content-stati">
		<h5><spring:message code="statistics.file.add.num"/></h5>
		<div class="form-horizontal form-con clearfix">
			<form name="addHistoryFileForm" id="addHistoryFileForm" class="row-fluid">
				<div class="span4">
		...
		<div class="table-con" id="fileAddTable" style="display: none"></div>
	</div>
</body>
</html>
...
function initTable(){
	opts_viewGrid = $("#fileAddTable").comboTableGrid({
		headData : headData,
		ItemOp : "user-defined",
		dataId : "date",
...
function createView(){
	...
	$.ajax({
		type : "POST",
		url : "${ctx}/statistics/getFileAddView/<c:out value='${treeNodeId}'/>",
		data : $("#addHistoryFileForm").serialize(),
		error : function(data) {
		...
		success : function(data) {
			...
			$("#fileAddTable").show();
			$("#fileAddTable").setTableGridData(catalogData, opts_viewGrid);
			}
