	...
	<div class="form-horizontal form-con clearfix">
   	<form id="userLoginConfigFrom" class="form-horizontal" method="post">
	    <div class="control-group">
		      ...
		      <div class="controls">
		            <input class="span4" type="text" id="threshold" name="threshold" value="<c:out value='${threshold}'/>" />
        ...
        <div class="control-group">
            <div class="controls">
            	<button id="submit_btn" type="button" onClick="saveUserConfig()" class="btn btn-primary"><spring:message code="common.save"/></button>
            </div>
        </div>
...
function saveUserConfig()
{
	...
	$.ajax({
		type: "POST",
		url:"${ctx}/sys/loginAlam/userConfig/save",
