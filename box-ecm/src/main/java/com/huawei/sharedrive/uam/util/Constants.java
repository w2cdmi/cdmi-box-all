...
public class Constants
{
    ...
    public final static int THRIFT_PORT = Integer.parseInt(PropertiesUtils.getProperty("thrift.app.port", "12000"));
    
    public final static int EMAIL_QUEUE_TASK_NUM = Integer.parseInt(PropertiesUtils.getProperty("email.taskNumber", "20"));
    ...
    public static final int DEFAULT_OTHER_SIZE = 20;
    ...
    public static final int STATUS_OF_ACCOUNT_ENABLE = 1;
    
    public static final int STATUS_OF_ACCOUNT_DISABLE = 0;
